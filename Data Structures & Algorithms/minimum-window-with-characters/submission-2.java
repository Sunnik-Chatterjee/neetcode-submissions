    ...
    public String minWindow(String s, String t) {
        ...
        for (int r = 0; r < s.length(); r++) {
            ...
            if (count2.containsKey(s.charAt(r))
                && count1.get(s.charAt(r)).equals(count2.get(s.charAt(r))))
                have++;
            while(have==need){
                if((r-l)+1<minLen){
                    minLen=(r-l)+1;
                ...
                if(count2.containsKey(s.charAt(l)) && count1.get(s.charAt(l))<count2.get(s.charAt(l))) have--;
                l++;
            }
        }
